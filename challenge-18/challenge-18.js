(function(){
  ...
  */
  ...
  console.log( '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>'.replace(/<(\w+)>([^<]+)<\/\w+>/g, function(regex,g1,g2){
      return '<'+g1+'>'+'O texto dentro da tag "'+g1+'" é "'+g2+'</'+g1+'>\n';
  } )  )
})()
