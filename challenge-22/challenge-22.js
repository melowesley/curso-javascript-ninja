(function(){
  ...
  */
  ...
  console.log( sum(10,20,30,200) );
  console.log( sum(10,20,561270) );
  ...
  */
  ...
  function justNumbers(numToStr){
    return numToStr.replace(/\D+/g, ',').split(',');
  }
