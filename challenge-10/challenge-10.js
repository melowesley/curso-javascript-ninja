...
(function(){
  ...
  */
  ...
  operationSignal = 'testeErro';
  var testeErro = calculator(operationSignal);

  if(testeErro){
    number1 = 10;
    number2 = 20;
    console.log(showOperationMessage(operationSignal, number1, number2), testeErro(number1, number2));
  } else {
    console.log(showErrorMessage(operationSignal));
  }
